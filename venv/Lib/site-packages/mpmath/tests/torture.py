...
in parallel if many cores are available. (A single tests may take between
...
* Generalize to tests more cases; more options.
...
* Some functions are notably absent, including the following:
  ...
  * zeta functions (need to modify tests not to try too large imaginary values)
  * and others...
