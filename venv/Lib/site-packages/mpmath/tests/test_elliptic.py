...
def test_jtheta():
    ...
    # tests for sin zeros for jtheta(1, z, q)
    # tests for cos zeros for jtheta(2, z, q)
    z1 = pi
    z2 = pi/2
    for i in range(10):
...
def test_jsn():
    ...
    # sn(z, 1) = tanh(z), m == 1
    #
    # It would be nice to tests these, but I find that they run
...
def test_elliptic_integrals():
    ...
    # more tests cases for the branch of ellippi / elliprj
