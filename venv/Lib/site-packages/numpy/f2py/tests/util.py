...
- building and importing modules on tests time, using a temporary location
...
def check_language(lang, code_snippet=None):
    ...
    try:
        ...
        try:
            ...
            pytest.skip("meson not present, skipping compiler dependent tests", allow_module_level=True)
