...
class TestDimSpec(util.F2PyTest):
    """This tests suite tests various expressions that are used as dimension
    specifications.
...
class TestUnicodeComment(util.F2PyTest):
    ...
    @pytest.mark.skipif(
        ...
        reason="tests requires charset_normalizer which is not installed",
    )
