...
class TestSetOps:
    ...
    def test_isin_additional(self, kind):
        # we use two different sizes for the b array here to tests the
...
class TestUnique:
    ...
    def test_unique_1d(self):
        ...
        # tests for ticket #2799
        aa = [1. + 0.j, 1 - 1.j, 1]
        assert_array_equal(np.unique(aa), [1. - 1.j, 1. + 0.j])

        # tests for ticket #4785
        a = [(1, 2), (1, 2), (2, 3)]
        unq = [1, 2, 3]
        inv = [[0, 1], [0, 1], [1, 2]]
        a1 = unique(a)
        ...
        # tests for chararrays with return_inverse (gh-5099)
        a = np.char.chararray(5)
        a[...] = ''
        a2, a2_inv = np.unique(a, return_inverse=True)
        assert_array_equal(a2_inv, np.zeros(5))

        # tests for ticket #9137
        a = []
        ...
        # tests for ticket 2111 - datetime64
        ...
        # tests for ticket 2111 - timedelta
    ...
    def test_unique_inverse_shape(self):
        # Regression tests for https://github.com/numpy/numpy/issues/25552
