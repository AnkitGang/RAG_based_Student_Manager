...
class TestAverage:
    ...
    def test_weights(self):
        ...
        # tests weights with `keepdims=False` and `keepdims=True`
...
class TestGradient:
    ...
    def test_specific_axes(self):
        ...
        # tests axis=None which means all axes
        ...
        assert_array_equal(gradient(x, 2, 3, axis=(1, 0)),
                           [dx[1]/2.0, dx[0]/3.0])
        # tests maximal number of varargs
...
class TestVectorize:
    ...
    def test_keywords_with_otypes_order1(self):
        ...
        # of these function calls is an important part of the tests.
    ...
    def test_keywords_no_func_code(self):
        # This needs to tests a function that has keywords but
    ...
    def test_UnboundMethod_ticket_1156(self):
        # Regression tests for issue 1156
        class Foo:
            b = 2
    ...
    def test_execution_order_ticket_1487(self):
        # Regression tests for dependence on execution order: issue 1487
...
class TestLeaks:
    ...
    @pytest.mark.skipif(NOGIL_BUILD,
                        reason=("Functions are immortalized if a thread is "
                                "launched, making this tests flaky"))
...
class TestCheckFinite:
    ...
    def test_dtype_order(self):
        # Regression tests for missing dtype and order arguments
        a = [1, 2, 3]
...
class Test_I0:
    ...
    def test_simple(self):
        ...
        # need at least one tests above 8, as the implementation is piecewise
...
class TestMeshgrid:
    ...
    def test_invalid_arguments(self):
        ...
        # Regression tests for issue #4755:
    ...
    def test_return_type(self):
        ...
        # Regression tests for issue #5297
...
class TestInterp:
    ...
    def test_right_left_behavior(self):
        # Needs range of sizes to tests different code paths.
    ...
    def test_non_finite_any_nan(self, sc):
        """ tests that nans are propagated """
    ...
    def test_complex_interp(self):
        # tests complex interpolation
        x = np.linspace(0, 1, 5)
        y = np.linspace(0, 1, 5) + (1 + np.linspace(0, 1, 5))*1.0j
        x0 = 0.3
        y0 = x0 + (1+x0)*1.0j
        assert_almost_equal(np.interp(x0, x, y), y0)
        # tests complex left and right
        x0 = -1
        left = 2 + 3.0j
...
class TestPercentile:
    ...
    def test_scalar_q(self):
        # tests for no empty dimensions for compatibility with old percentile
        x = np.arange(12).reshape(3, 4)
...
class TestQuantile:
    ...
    def test_quantile_monotonic(self, method):
        # GH 14685
        # tests that the return value of quantile is monotonic if p0 is ordered
        ...
        # Also tests one where the number of data points is clearly divisible:
