...
class TestSavezLoad(RoundtripTest):
    ...
    def test_closing_fid(self):
        ...
        # It might be a "weak" tests since failed to get triggered on
    ...
    def test_closing_zipfile_after_load(self):
        ...
        # pass a file name to load for the tests. On windows failure will
...
class TestSaveTxt:
    ...
    def test_unicode(self):
        ...
        with tempdir() as tmpdir:
            ...
            np.savetxt(os.path.join(tmpdir, 'tests.csv'), a, fmt=['%s'],
                       encoding='UTF-8')
    ...
    def test_unicode_roundtrip(self):
        ...
        with tempdir() as tmpdir:
            for suffix in suffixes:
                np.savetxt(os.path.join(tmpdir, 'tests.csv' + suffix), a,
                           fmt=['%s'], encoding='UTF-16-LE')
                b = np.loadtxt(os.path.join(tmpdir, 'tests.csv' + suffix),
    ...
    def test_large_zip(self):
        def check_large_zip(memoryerror_raised):
            ...
            try:
                # The tests takes at least 6GB of memory, writes a file larger
                # than 4GB. This tests the ``allowZip64`` kwarg to ``zipfile``
                test_data = np.asarray([np.random.rand(
                                        np.random.randint(50,100),4)
                                        for i in range(800000)], dtype=object)
                with tempdir() as tmpdir:
                    np.savez(os.path.join(tmpdir, 'tests.npz'),
                             test_data=test_data)
            except MemoryError:
        ...
        # on memory sharing model, lead to failed tests for check_large_zip
...
class LoadTxtBase:
    ...
    def test_converters_decode(self):
        # tests converters that decode strings
        c = TextIO()
        c.write(b'\xcf\x96')
        c.seek(0)
    ...
    def test_converters_nodecode(self):
        # tests native string converters enabled by setting an encoding
        utf8 = b'\xcf\x96'.decode('UTF-8')
        with temppath() as path:
...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_default_float_converter_no_default_hex_conversion(self):
        ...
        is not called by default. Regression tests related to gh-19598.
        """
        c = TextIO("a b c")
    ...
    def test_default_float_converter_exception(self):
        ...
        conversion is correct. Regression tests related to gh-19598.
        """
    ...
    def test_binary_load(self):
        ...
        with temppath() as path:
            ...
            # tests broken latin1 conversion people now rely on
            with open(path, "rb") as f:
...
M   33  21.99
    ...
    def test_file_is_closed_on_error(self):
        # gh-13200
        with tempdir() as tmpdir:
            fpath = os.path.join(tmpdir, "tests.csv")
    ...
    def test_utf8_file_nodtype_unicode(self):
        ...
        # skip tests if cannot encode utf8 tests string with preferred
    ...
    def test_auto_dtype_largeint(self):
        # Regression tests for numpy/numpy#5635 whereby large integers could
...
def test_gzip_loadtxt():
    ...
    # of the tests reference array, write it to a securely opened file,
