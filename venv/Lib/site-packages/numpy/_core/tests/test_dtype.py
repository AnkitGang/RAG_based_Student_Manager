...
class TestBuiltin:
    ...
    def test_dtype(self, t):
        ...
        dt3 = dt.newbyteorder(">")
        if dt == dt2:
            assert_(dt.byteorder != dt2.byteorder, "bogus tests")
            assert_dtype_equal(dt, dt2)
        else:
            assert_(dt.byteorder != dt3.byteorder, "bogus tests")
...
class TestRecord:
    ...
    def test_from_dict_with_zero_width_field(self):
        # Regression tests for #6430 / #2196
    ...
    def test_nonstructured_with_object(self):
        ...
        # assert about that fails, the tests becomes meaningless (which is OK)
...
class TestSubarray:
    ...
    def test_aligned_empty(self):
        # Mainly regression tests for gh-19696: construction failed completely
        dt = np.dtype([], align=True)
        assert dt == np.dtype([])
...
@pytest.mark.skipif(
    ...
    reason="Python 3.12 has immortal refcounts, this tests will no longer "
           "work. See gh-23986"
)
@pytest.mark.skipif(not HAS_REFCOUNT, reason="Python lacks refcounts")
class TestStructuredObjectRefcounting:
    ...
    def test_structured_object_create_delete(self, dt, pat, count, singleton,
        ...
        # The tests assumes that 0, 1, and None are singletons.
        gc.collect()
...
class TestDTypeMakeCanonical:
    ...
    def test_structured(self, dtype):
        ...
        # case hypothesis grows support for `align`.  Then repeat the tests:
...
def test_rational_dtype():
    # tests for bug gh-5719
    a = np.array([1111], dtype=rational).astype
    assert_raises(OverflowError, a, 'int8')

    # tests that dtype detection finds user-defined types
    x = rational(1)
...
def test_keyword_argument():
    # tests for https://github.com/numpy/numpy/pull/16574#issuecomment-642660971
...
class TestUserDType:
    ...
    def test_custom_structured_dtype(self):
        ...
        if HAS_REFCOUNT:
            # Create an array and tests that memory gets cleaned up (gh-25949)
            o = object()
...
def test_result_type_integers_and_unitless_timedelta64():
    # Regression tests for gh-20077.  The following call of `result_type`
...
def test_creating_dtype_with_dtype_class_errors():
    # Regression tests for #25031, calling `np.dtype` with itself segfaulted.
