...
class _SIMD_BOOL(_Test_Utility):
    """
    To tests all boolean vector types at once
    """
    def _nlanes(self):
...
class _SIMD_INT(_Test_Utility):
    """
    To tests all integer vector types at once
    """
...
class _SIMD_FP32(_Test_Utility):
    """
    To only tests single precision
    """
...
class _SIMD_FP64(_Test_Utility):
    """
    To only tests double precision
    """
    def test_conversions(self):
        """
        Round to nearest even integer, assume CPU control register is set to rounding.
...
class _SIMD_FP(_Test_Utility):
    """
    To tests all float vector types at once
    """
...
class _SIMD_ALL(_Test_Utility):
    """
    To tests all vector types at once
    """
    ...
    def test_memory_partial_load(self, intrin, elsizes, scale, fill):
        ...
        lanes += [self.nlanes**2, self.nlanes**4] # tests out of range
        for n in lanes:
    ...
    def test_arithmetic_intdiv(self):
        ...
        data = [1, -int_min]  # to tests overflow
