...
class TestIndexing:
    ...
    def test_same_kind_index_casting(self):
        ...
        # is somewhat unsafe. So tests various different code paths.
        index = np.arange(5)
    ...
    def test_boolean_indexing_list(self):
        # Regression tests for #13715. It's a use-after-free bug which the
        # tests won't directly catch, but it will show up in valgrind.
        a = np.array([1, 2, 3])
        b = [True, False, True]
        # Two variants of the tests because the first takes a fast path
    ...
    def test_reversed_strides_result_allocation(self):
        ...
        # when the subspace size was 1 (and tests other cases as well)
        a = np.arange(10)[:, None]
        i = np.arange(10)[::-1]
    ...
    def test_array_like_values(self):
        # Similar to the above tests, but use a memoryview instead
        a = np.zeros((5, 5))
    ...
    def test_broken_sequence_not_nd_index(self):
        ...
        # also tests that field indexing does not segfault
    ...
    def test_structured_advanced_indexing(self):
        ...
        # for structured datatypes, see gh-15387. This tests can behave randomly.
...
class TestSubclasses:
    def test_basic(self):
        ...
        # where a copy was made (latter a regression tests for gh-11983).
        class SubClass(np.ndarray):
            pass
...
class TestFancyIndexingEquivalence:
    def test_object_assign(self):
        ...
        # tests same for subspace fancy indexing
        ...
        # Another tests for the memory order of the subspace
    ...
    def test_cast_equivalence(self):
        ...
        # tests the same for subspace fancy indexing
        b = np.arange(5)[None, :]
...
class TestMultiIndexingAutomated:
    ...
    Update 2016-11-30: It is probably not worth maintaining this tests
    ...
    def setup_method(self):
        ...
        self.complex_indices = ['skip', Ellipsis,
            ...
            # dimensions, also need to tests all False
    ...
    def test_multidim(self):
        # Automatically tests combinations with complex indexes on 2nd (or 1st)
...
class TestFloatNonIntegerArgument:
    """
    These tests that ``TypeError`` is raised when you try to use
