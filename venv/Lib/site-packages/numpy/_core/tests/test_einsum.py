...
class TestEinsum:
    ...
    def test_einsum_specific_errors(self, do_opt):
        ...
        assert_raises(TypeError, np.einsum, "", 0, out='tests',
                      optimize=do_opt)
    ...
    def test_einsum_misc(self):
        ...
        # Regression tests for issue #10369 (tests unicode inputs with Python 2)
        assert_equal(np.einsum('ij...,j...->i...', a, b), [[[2], [2]]])
    ...
    def test_einsum_broadcast(self):
        ...
        # We need to tests the optimized parsing as well
    ...
    def test_einsum_fixedstridebug(self):
        ...
        # of the stride in question, which in the tests case reveals that
        # the stride is not fixed.
        #
        # NOTE: This tests is triggered by the fact that the default buffersize,
        ...
        assert_equal(es,  tp)
        # The following is the original tests case from the bug report,
    ...
    def test_different_paths(self, dtype):
        ...
        dtype = np.dtype(dtype)
        # Simple tests, designed to exercise most specialized code paths,
