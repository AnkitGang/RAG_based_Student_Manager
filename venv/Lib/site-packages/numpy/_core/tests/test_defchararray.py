...
class TestOperations:
    ...
    def test_slice(self):
        """Regression tests for https://github.com/numpy/numpy/issues/5982"""
    ...
    def test_getitem_length_zero_item(self, data):
        # Regression tests for gh-26375.
        a = np.char.array(data)
        # a.dtype.type() will be an empty string or bytes instance.
        # The equality tests will fail if a[1] has the wrong type
...
def test_empty_indexing():
    """Regression tests for ticket 1948."""
