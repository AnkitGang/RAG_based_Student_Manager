...
class TestGeomspace:
    ...
    def test_complex_shortest_path(self):
        # tests the shortest logarithmic spiral is used, see gh-25644
        x = 1.2 + 3.4j
...
class TestLinspace:
    ...
    def test_array_interface(self):
        # Regression tests for https://github.com/numpy/numpy/pull/6659
        ...
        class Arrayish:
            ...
            def __mul__(self, other):
                # For the purposes of this tests any multiplication is an
                # identity operation :)
                return self
    ...
    def test_denormal_numbers(self):
        # Regression tests for gh-5437. Will probably fail when compiled
...
class TestAdd_newdoc:
    ...
    def test_add_doc(self):
        # tests that np.add_newdoc did attach a docstring successfully:
