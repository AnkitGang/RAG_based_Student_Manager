...
def test_array_scalar_ufunc_equivalence(op, arr1, arr2):
    """
    This is a thorough tests attempting to cover important promotion paths
...
class TestBaseMath:
    ...
    def test_blocked(self):
        # tests alignments offsets for simd instructions
...
class TestRepr:
    ...
    def test_float_repr(self):
        # long double tests cannot work, because eval goes through a python
        # float
...
def test_subclass_deferral(sctype, __op__, __rop__, op, cmp):
    """
    This tests covers scalar subclass deferral.  Note that this is exceedingly
...
def test_longdouble_complex():
    # Simple tests to check longdouble and complex combinations, since these
...
def test_pyscalar_subclasses(subtype, __op__, __rop__, op, cmp):
    ...
    if op in {operator.mod, operator.floordiv} and subtype == complex:
        return  # module is not support for complex.  Do not tests.
