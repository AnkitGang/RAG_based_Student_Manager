...
class TestNonarrayArgs:
    ...
    def test_std_with_mean_keyword(self):
        # Setting the seed to make the tests reproducible
...
class TestBoolArray:
    ...
    def test_all_any(self):
        ...
        # big array tests for blocked libc loops
...
class TestBoolCmp:
    def setup_method(self):
        ...
        # We disable the float32 sign tests on riscv64 for -np.nan as the sign
...
class TestTypes:
    ...
    def test_promote_types_metadata(self, dtype1, dtype2):
        ...
        right now in NumPy. This tests should thus be considered to
        document behaviour, rather than tests the correct definition of it.

        This tests is very ugly, it was useful for rewriting part of the
        ...
        try:
            ...
            # Promotion failed, this tests only checks metadata
            return
    ...
    def test_can_cast_scalars(self, dtype):
        # Basic tests to ensure that scalars are supported in can-cast
...
# Custom exception class to tests exception propagation in fromiter
...
class TestNonzero:
    ...
    def test_sparse(self):
        # tests special sparse condition boolean code path
        for i in range(20):
    ...
    def test_count_nonzero_axis_all_dtypes(self):
        # More thorough tests that the axis argument is respected
    ...
    def test_structured_threadsafety(self):
        ...
        # structured datatypes, see gh-15387. This tests can behave randomly.
...
class TestBinaryRepr:
    ...
    def test_neg_width_boundaries(self):
        ...
        # break before proceeding to a more thorough tests.
...
class TestArrayComparisons:
    ...
    def test_array_equal_equal_nan(self, bx, by, equal_nan, expected):
        """
        This tests array_equal for a few combinations:
    ...
    def test_compare_unstructured_voids(self, dtype):
        ...
        if dtype == "V0":
            # Can't tests != of actually different data
            return
...
class TestClip:
    ...
    def test_clip_property(self, data, arr):
        """A property-based tests using Hypothesis.
        ...
        values *inside* the tests function, from strategies we construct based
        ...
        That accounts for most of the function; the actual tests is just three
...
class TestIsclose:
    ...
    def test_masked_arrays(self):
        # Make sure to tests the output type when arguments are interchanged.
