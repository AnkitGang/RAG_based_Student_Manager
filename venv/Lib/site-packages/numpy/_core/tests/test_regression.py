...
class TestRegression:
    ...
    def test_nonarray_assignment(self, index):
        # See also Issue gh-2870, tests for non-array assignment
    ...
    def test_reshape_zero_strides(self):
        # Issue #380, tests reshaping of zero strided arrays
        a = np.ones(1)
    ...
    def test_astype_copy(self):
        ...
        # The tests data file was generated by scipy.io.savemat.
    ...
    def test_void_scalar_constructor(self):
        ...
        #Create tests string data, construct void scalar from data and assert
        #that void scalar contains original data.
        test_string = np.array("tests")
    ...
    @pytest.mark.skipif(
        ...
        reason="Python 3.12 has immortal refcounts, this tests no longer works."
    )
    @pytest.mark.skipif(not HAS_REFCOUNT, reason="Python lacks refcounts")
    def test_structured_arrays_with_objects2(self):
        # Ticket #1299 second tests
        stra = 'aaaa'
        strb = 'bbbb'
    ...
    def test_string_truncation(self):
        ...
        for val in [True, 1234, 123.4, complex(1, 234)]:
            for tostr, dtype in [(asunicode, "U"), (asbytes, "S")]:
                ...
                # tests also with longer strings
    ...
    def test_frompyfunc_name(self):
        ...
        # resulting in the default '?' name. Also tests utf-8
    ...
    def test_nonbool_logical(self):
        ...
        # needs to be large enough to tests both SIMD and scalar paths
        size = 100
    ...
    def test_logspace_base_does_not_determine_dtype(self):
        ...
        # Check tests fails if the calculation is done in float64, as happened
