...
def bad_arcsinh():
    ...
    tests. This should be fixed when we can move past glibc2.17
...
class TestDivision:
    ...
    def test_division_int_boundary(self, dtype, ex_val):
        ...
        # Large enough to tests SIMD loops and remainder elements
        lsize = 512 + 7
    ...
    def test_floor_division_corner_cases(self, dtype):
        # tests corner cases like 1.0//0.0 for errors and return vals
...
class TestRemainder:
    ...
    def test_float_remainder_exact(self):
        # tests that float results are exact for small integers. This also
...
class TestLogAddExp2(_FilterInvalids):
    # Need tests for intermediate precisions
...
class TestSpecialFloats:
    ...
    # tests to ensure no spurious FP exceptions are raised due to SIMD
    INF_INVALID_ERR = [
...
class TestFPClass:
    ...
    def test_fpclass(self, stride):
        ...
        if platform.machine() == 'riscv64':
            ...
            # We disable the sign tests on riscv64 for -np.nan as we
            ...
            for size in range(1,32):
                ...
                if maxulperr == 0:
                    ...
                    assert_array_max_ulp(myfunc(x_f64),
                                         ...
                                         maxulp=maxulperr)
                # various strides to tests gather instruction
                if size > 1:
...
class TestAVXFloat32Transcendental:
    ...
    def test_sincos_float32(self):
        ...
        if not _glibc_older_than("2.17"):
            # tests coverage for elements > 117435.992f for which glibc is used
...
class TestMinMax:
    def test_minmax_blocked(self):
        # simd tests on max/min, tests all alignments, slow but important
...
class TestAbsoluteNegative:
    def test_abs_neg_blocked(self):
        # simd tests on abs, tests all alignments for vz + 2 * (vs - 1) + 1
...
class TestSpecialMethods:
    ...
    def test_wrap_out(self):
        ...
        class StoreArrayPrepareWrap(np.ndarray):
            ...
            def __repr__(self):
                return "a"  # for short tests output
    ...
    def test_array_ufunc_direct_call(self):
        # This is mainly a regression tests for gh-24023 (shouldn't segfault)
        a = np.array(1)
        with pytest.raises(TypeError):
            a.__array_ufunc__()
...
class TestRationalFunctions:
    ...
    def _test_lcm_inner(self, dtype):
        ...
        # broadcasting, and a tests including 0
...
class TestRoundingFunctions:
    ...
    def test_object_direct(self):
        """ tests direct implementation of these magic methods """
        class C:
            def __floor__(self):
                return 1
            def __ceil__(self):
    ...
    def test_object_indirect(self):
        """ tests implementations via __float__ """
        class C:
            def __float__(self):
                return -2.5
...
def test_reduceat():
    ...
    # tests buffered -- this should work
...
class TestAddDocstring:
    ...
    def test_add_same_docstring(self):
        # tests for attributes (which are C-level defined)
