...
class TestConcatenate:
    ...
    def test_exceptions(self):
        ...
        # tests shapes must match except for concatenation axis
        a = np.ones((1, 2, 3))
        b = np.ones((2, 2, 3))
        axis = list(range(3))
        for i in range(3):
...
class TestBlock:
    ...
    def block(self, request):
        ...
        # copies required.
        # We define a tests fixture that forces most tests to go through
        # both code paths.
