...
def test_new_policy(get_module):
    ...
    # tests array manipulation. This is slow
    if orig_policy_name == 'default_allocator':
        # when the np._core.tests tests recurse into this tests, the
        ...
        # also try the ma tests, the pickling tests is quite tricky
