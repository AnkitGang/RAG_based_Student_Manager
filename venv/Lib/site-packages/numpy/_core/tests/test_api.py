...
def test_array_astype():
    ...
    # Same tests as above but for strings shorter than 64 characters
...
def test_array_astype_to_string_discovery_empty(dt):
    ...
    # The important part the tests is rather that it does not error.
...
def test_array_astype_warning(t):
    # tests ComplexWarning when casting from complex to float or int
...
def test_none_to_nan_cast(dtype):
    # Note that at the time of writing this tests, the scalar constructors
    # reject None
...
def test_copyto_permut():
    ...
    # tests all permutation of possible masks, 9 should be sufficient for
...
def test_astype_copyflag():
    # tests the various copyflag options
