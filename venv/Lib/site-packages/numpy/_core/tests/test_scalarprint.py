...
class TestRealScalars:
    ...
    def test_scalar_cutoffs(self):
        # tests that both the str and repr of np.float64 behaves
    ...
    def test_dragon4(self):
        ...
        assert_equal(fpos32(f32x, unique=False, fractional=False, precision=4),
                    "340300000000000000000000000000000000000.")
        # tests that unique rounding is preserved when precision is supplied
    ...
    def test_dragon4_positional_interface(self, tp):
        # tests is flaky for musllinux on np.float128
        if IS_MUSL and tp == np.float128:
            pytest.skip("Skipping flaky tests of float128 on musllinux")
