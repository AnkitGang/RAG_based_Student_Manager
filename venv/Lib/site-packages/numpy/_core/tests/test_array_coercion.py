...
class TestScalarDiscovery:
    ...
    # Additionally to string this tests also runs into a corner case
    ...
    def test_scalar_coercion_same_as_cast_and_assignment(self, cast_to):
        ...
        for scalar in scalar_instances(times=False):
            ...
            # The main tests, we first try to use casting and if it succeeds
            # continue below testing that things are the same, otherwise
            # tests that the alternative paths at least also fail.
            try:
...
class TestBadSequences:
    ...
    # Note: We do not tests a shrinking list.  These do very evil things
...
class TestArrayLikes:
    ...
    def test_array_interface_descr_optional(self):
        # The descr should be optional regression tests for gh-27249
