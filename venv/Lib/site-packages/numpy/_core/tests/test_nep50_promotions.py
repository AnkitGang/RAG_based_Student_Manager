"""
This file adds basic tests to tests the NEP 50 style promotion compatibility
mode.  Most of these tests are likely to be simply deleted again once NEP 50
is adopted in the main tests suite.  A few may be moved elsewhere.
"""
...
def test_integer_comparison_with_cast(arr):
    # Similar to above, but mainly tests a few cases that cover the slow path
    # the tests is limited to unsigned ints and -1 for simplicity.
    res = arr >= -1
