...
def test_import_lazy_import(name):
    ...
    We also tests for the presence of the lazily imported modules in dir
...
# Stuff that clearly shouldn't be in the API and is detected by the next tests
# below
SKIP_LIST_2 = [
    'numpy.lib.math',
    'numpy.matlib.char',
...
def test_all_modules_are_expected_2():
    ...
    only filenames.  So this tests is more thorough, and checks this like:
...
@pytest.mark.xfail(
    ...
    reason=(
        "NumPy possibly built with `USE_DEBUG=True ./tools/travis-tests.sh`, "
...
def test_array_api_entry_point():
    ...
    # the entrypoint will not have been installed. So ensure this tests fails
    ...
    try:
        ...
        # Array API entry points so that running this tests in <=3.9 will
...
def test_core_shims_coherence():
    ...
    for member_name in dir(np._core):
        # Skip private and tests members. Also if a module is aliased,
...
def test_functions_single_location():
    ...
    # It must be empty for the tests to pass.
