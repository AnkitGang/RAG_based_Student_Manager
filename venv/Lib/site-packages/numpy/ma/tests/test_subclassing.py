...
class WrappedArray(NDArrayOperatorsMixin):
    """
    Wrapping a MaskedArray rather than subclassing to tests that
...
class TestSubclassing:
    ...
    def test_subclass_items(self):
        """tests that getter and setter go via baseclass"""
        x = np.arange(5)
    ...
    def test_subclass_repr(self):
        """tests that repr uses the name of the subclass
    ...
    def test_subclass_str(self):
        """tests str with subclass that has overridden str, setitem"""
    ...
    def test_pure_subclass_info_preservation(self):
        ...
        # see gh-7122.
        arr1 = SubMaskedArray('tests', data=[1,2,3,4,5,6])
        arr2 = SubMaskedArray(data=[0,1,2,3,4,5])
        diff1 = np.subtract(arr1, arr2)
        assert_('info' in diff1._optinfo)
        assert_(diff1._optinfo['info'] == 'tests')
        diff2 = arr1 - arr2
        assert_('info' in diff2._optinfo)
        assert_(diff2._optinfo['info'] == 'tests')
