...
class TestAssertAllclose:
    ...
    def test_error_message_unsigned(self):
        """Check the message is formatted correctly when overflow can occur
           (gh21768)"""
        # Ensure to tests for potential overflow in the case of:
        #        x - y
        # and
        #        y - x
...
class TestArrayAlmostEqualNulp:
    ...
    def test_complex128_pass(self):
        ...
        # The tests condition needs to be at least a factor of sqrt(2) smaller
...
def assert_warn_len_equal(mod, n_in_context):
    try:
        ...
        # a parallel tests scenario, while in
        # a serial tests scenario an initial
...
def test_warn_len_equal_call_scenarios():
    ...
    # vs. parallel tests scenarios; this tests
    ...
    # serial tests scenario -- the __warningregistry__
...
def test_suppress_warnings_module():
    ...
    with suppress_warnings() as sup:
        ...
        warnings.warn("Some warning")
        warn_other_module()
    # Check that the suppression did tests the file correctly (this module
    # got filtered)
    ...
    def test_fails(self):
        ...
        try:
            ...
            try:
                ...
                # the above tests is only necessary if the GC actually tried to free
