...
# architectures and compilers to tests
arch_compilers = dict(
...
class _Test_CCompilerOpt:
    ...
    def test_targets(self):
        # tests skipping baseline features
        self.expect_targets(
            """
            /*@targets
        ...
        # tests skipping non-dispatch features
        self.expect_targets(
            """
            /*@targets
        ...
        # tests skipping features that not supported
        self.expect_targets(
            """
            /*@targets
        ...
        # tests skipping features that implies each other
        self.expect_targets(
            """
            /*@targets
    ...
    def test_targets_groups(self):
        ...
        # tests skip duplicating and sorting
        self.expect_targets(
            """
            /*@targets
             * sse42 avx avx512f
    ...
    def test_targets_multi(self):
        ...
        # tests skipping implied features and auto-sort
        self.expect_targets(
            """
            /*@targets
        ...
        # tests skipping implied features and keep sort
        self.expect_targets(
            """
            /*@targets $keep_sort
        ...
        # tests compiler variety and avoiding duplicating
        self.expect_targets(
            """
            /*@targets $keep_sort
