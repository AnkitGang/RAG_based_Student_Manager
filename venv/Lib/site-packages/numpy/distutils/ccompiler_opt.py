...
class _Config:
    ...
    conf_features : dict
        ...
        "extra_checks": str or list, optional
            Extra tests case names for the CPU feature that need to be tested
            against the compiler.

            Each tests case must have a C file named ``extra_xxxx.c``, where
            ``xxxx`` is the case name in lower case, under 'conf_check_path'.
            It should contain at least one intrinsic or function related to the tests case.
    ...
    conf_cc_flags = dict(
        ...
        clang = dict(
            ...
            # cases `-Werror` gets skipped during the availability tests due to
...
class _Feature:
    ...
    def feature_names(self, names=None, force_flags=None, macros=[]):
        ...
        names : sequence or None, optional
            Specify certain CPU features to tests it against the **C** compiler.
            if None(default), it will tests all current supported features.
    ...
    def feature_test(self, name, force_flags=None, macros=[]):
        ...
        if not os.path.exists(test_path):
            self.dist_fatal("feature tests file is not exist", test_path)
