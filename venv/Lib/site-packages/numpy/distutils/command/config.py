...
class config(old_config):
    ...
    def check_type_size(self, type_name, headers=None, include_dirs=None, library_dirs=None, expected=None):
        ...
        while True:
            try:
                ...
                #log.info("failure to tests for bound %d" % mid)
                low = mid + 1
                mid = 2 * mid + 1
    ...
    def check_func(self, func,
        ...
        # Useful to tests for some functions when built with optimization on, to
        # avoid build error because the intrinsic and our 'fake' tests
