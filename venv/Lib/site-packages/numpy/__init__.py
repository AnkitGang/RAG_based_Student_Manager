...
if __NUMPY_SETUP__:
    ...
    __numpy_submodules__ = {
        ...
        "f2py", "tests", "rec", "char", "core", "strings",
    }
    ...
    def _sanity_check():
        ...
        achieved during tests suite runs, and it is useful to catch those early.
    ...
    if sys.platform == "darwin":
        ...
        with warnings.catch_warnings(record=True) as w:
            _mac_os_check()
            # Throw runtime error, if the tests failed Check for warning and error_message
            if len(w) > 0:
                for _wn in w:
                    if _wn.category is exceptions.RankWarning:
                        ...
                        msg = (
                            "Polyfit sanity tests emitted a warning, most likely due "
