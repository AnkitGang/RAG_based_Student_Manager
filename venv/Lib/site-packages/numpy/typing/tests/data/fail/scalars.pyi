...
np.void("tests")  # E: No overload variant
np.void("tests", dtype=None)  # E: No overload variant

np.generic(1)  # E: Cannot instantiate abstract class
np.number(1)  # E: Cannot instantiate abstract class
np.integer(1)  # E: Cannot instantiate abstract class
np.inexact(1)  # E: Cannot instantiate abstract class
np.character("tests")  # E: Cannot instantiate abstract class
np.flexible(b"tests")  # E: Cannot instantiate abstract class
...
np.bytes_(value=b'tests')  # E: No overload variant
np.void(value=b'tests')  # E: No overload variant
