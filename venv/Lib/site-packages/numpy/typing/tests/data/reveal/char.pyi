...
assert_type(np.char.mod(AR_U, "tests"), npt.NDArray[np.str_])
assert_type(np.char.mod(AR_S, "tests"), npt.NDArray[np.bytes_])
assert_type(np.char.mod(AR_T, "tests"), AR_T_alias)
