...
assert_type(np.testing.assert_(1, msg="tests"), None)
assert_type(np.testing.assert_(2, msg=lambda: "tests"), None)
...
assert_type(np.testing.build_err_msg([0, 1, 2], "tests"), str)
assert_type(np.testing.build_err_msg(range(2), "tests", header="header"), str)
assert_type(np.testing.build_err_msg(np.arange(9).reshape(3, 3), "tests", verbose=False), str)
assert_type(np.testing.build_err_msg("abc", "tests", names=["x", "y"]), str)
assert_type(np.testing.build_err_msg([1.0, 2.0], "tests", precision=5), str)
...
assert_type(np.testing.assert_array_compare(func2, AR_i8, AR_f8, err_msg="tests"), None)
...
assert_type(np.testing.assert_array_equal(AR_i8, AR_f8, err_msg="tests"), None)
...
assert_type(np.testing.assert_array_almost_equal(AR_i8, AR_f8, err_msg="tests"), None)
...
assert_type(np.testing.assert_array_less(AR_i8, AR_f8, err_msg="tests"), None)
...
assert_type(np.testing.rundocs("tests.py"), None)
assert_type(np.testing.rundocs(Path("tests.py"), raise_on_error=True), None)
...
assert_type(
    np.testing.assert_raises_regex(RuntimeWarning, r"tests"),
    unittest.case._AssertRaisesContext[RuntimeWarning],
)
assert_type(np.testing.assert_raises_regex(RuntimeWarning, b"tests", func3, 5), None)
assert_type(np.testing.assert_raises_regex(RuntimeWarning, re.compile(b"tests"), func3, 5), None)
...
assert_type(np.testing.decorate_methods(Test, decorate, "tests"), None)
assert_type(np.testing.decorate_methods(Test, decorate, b"tests"), None)
assert_type(np.testing.decorate_methods(Test, decorate, re.compile("tests")), None)
...
assert_type(np.testing.assert_no_warnings(func4, a=1, b="tests"), bool)
assert_type(np.testing.assert_no_warnings(func4, 1, "tests"), bool)

assert_type(np.testing.tempdir("test_dir"), contextlib._GeneratorContextManager[str])
assert_type(np.testing.tempdir(prefix=b"tests"), contextlib._GeneratorContextManager[bytes])
...
assert_type(np.testing.temppath(prefix=b"tests"), contextlib._GeneratorContextManager[bytes])
