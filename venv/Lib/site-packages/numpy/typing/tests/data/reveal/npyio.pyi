...
assert_type(npz_file["tests"], npt.NDArray[Any])
...
assert_type(np.loadtxt(str_file, comments="tests"), npt.NDArray[np.float64])
...
assert_type(np.fromregex(bytes_file, "tests", np.float64), npt.NDArray[np.float64])
assert_type(np.fromregex(str_file, b"tests", dtype=float), npt.NDArray[Any])
assert_type(np.fromregex(str_path, re.compile("tests"), dtype=np.str_, encoding="utf8"), npt.NDArray[np.str_])
assert_type(np.fromregex(pathlib_path, "tests", np.float64), npt.NDArray[np.float64])
assert_type(np.fromregex(bytes_reader, "tests", np.float64), npt.NDArray[np.float64])
...
assert_type(np.genfromtxt(str_file, comments="tests"), npt.NDArray[Any])
