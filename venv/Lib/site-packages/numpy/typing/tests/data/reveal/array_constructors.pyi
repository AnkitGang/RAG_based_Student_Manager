...
assert_type(np.fromfile("tests.txt", sep=" "), npt.NDArray[np.float64])
assert_type(np.fromfile("tests.txt", dtype=np.int64, sep=" "), npt.NDArray[np.int64])
assert_type(np.fromfile("tests.txt", dtype="c16", sep=" "), npt.NDArray[Any])
with open("tests.txt") as f:
    assert_type(np.fromfile(f, sep=" "), npt.NDArray[np.float64])
    assert_type(np.fromfile(b"tests.txt", sep=" "), npt.NDArray[np.float64])
    assert_type(np.fromfile(Path("tests.txt"), sep=" "), npt.NDArray[np.float64])
