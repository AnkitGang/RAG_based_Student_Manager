...
class TestRegression:
    ...
    def test_vonmises_range(self):
        ...
        # Regression tests for ticket #986.
    ...
    def test_zipf_large_parameter(self):
        # Regression tests for part of gh-9829: a call such as rng.zipf(10000)
        # would hang.
        n = 8
    ...
    def test_zipf_a_near_1(self):
        # Regression tests for gh-9829: a call such as rng.zipf(1.0000000000001)
        # would hang.
        n = 100000
        sample = self.mt19937.zipf(1.0000000000001, size=n)
        # Not much of a tests, but let's do something more than verify that
