...
class TestBinomial:
    def test_n_zero(self):
        ...
        # This tests addresses issue #3480.
...
class TestMultivariateHypergeometric:
    ...
    def test_edge_cases(self, method):
        # Set the seed, but in fact, all the results in this tests are
...
def test_pickle_preserves_seed_sequence():
    # GH 26234
    # Add explicit tests that bit generators preserve seed sequences
    import pickle
