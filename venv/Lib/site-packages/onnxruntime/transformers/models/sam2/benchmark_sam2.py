...
class OrtTestSession:
    """A wrapper of ORT session to tests relevance and performance."""
...
def _parse_arguments():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="number of repeats for performance tests. Default is 1000.",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Enable nvtx profiling. It will add an extra run for profiling before performance tests.",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Enable PyTorch profiling. It will add an extra run for profiling before performance tests.",
    )
