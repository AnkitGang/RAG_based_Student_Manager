...
# It outputs a csv file with Mann-Whitney U tests and T-Test on each pair of experiments, where
...
def parse_arguments(argv=None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="number of tests cases per run",
    )
    ...
    parser.add_argument(
        ...
        required=False,
        action="store_true",
        help="do not run tests, and only rank experiments based on existing csv file",
    )
...
if __name__ == "__main__":
    ...
    if args.test_cases < 100 or args.runs < 20 or args.test_cases * args.runs < 10000:
        logger.warning(
            "Not enough tests cases or runs to get stable results or tests significance. "
