...
def parse_arguments(argv=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Path to the file with inputs to tests with",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Number of tests cases per run for parity",
    )
    parser.add_argument(
        "-r",
        "--test_runs",
        ...
        type=int,
        default=10,
        help="Number of runs for parity. It is used for significance tests.",
    )
...
def main(argv=None, experiment_name: str = "", run_id: str = "0", csv_filename: str = "gpt2_parity_results.csv"):
    ...
    )  # Do not remove raw model to save time in parity tests
    ...
    if args.input_test_file:
        test_inputs = []
        # Each line of tests file is a JSON string like:
