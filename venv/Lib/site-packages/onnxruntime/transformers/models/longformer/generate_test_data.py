...
# Generate tests data for a longformer model, so that we can use onnxruntime_perf_test.exe to evaluate the inference latency.
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="output tests data path. If not specified, .",
    )
...
def fake_test_data(
    ...
    """
    Generate fake input data for tests.
    """
