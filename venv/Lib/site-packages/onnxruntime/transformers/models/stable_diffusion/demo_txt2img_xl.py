...
def run_turbo_demo(args):
    """Run demo of generating images with tests prompts with ORT CUDA provider."""
    args.engine = "ORT_CUDA"
    base, refiner = load_pipelines(args, 1)
    ...
    num_rows = dataset["tests"].num_rows
    batch_size = args.batch_size
    num_batch = int(num_rows / batch_size)
    args.batch_size = 1
    for i in range(num_batch):
        args.prompt = [dataset["tests"][i]["Prompt"] for i in range(i * batch_size, (i + 1) * batch_size)]
