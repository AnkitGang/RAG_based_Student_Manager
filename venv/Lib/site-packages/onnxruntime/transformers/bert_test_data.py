...
# It is a tool to generate tests data for a bert model.
# The tests data can be used by onnxruntime_perf_test tool to evaluate the inference latency.
...
def output_test_data(directory: str, inputs: dict[str, np.ndarray]):
    """Output input tensors of tests data to a directory
...
def fake_test_data(
    ...
    Args:
        batch_size (int): batch size
        sequence_length (int): sequence length
        test_cases (int): number of tests cases
    ...
    Returns:
        List[Dict[str,numpy.ndarray]]: list of tests cases, where each tests case is a dictionary
...
def generate_test_data(
    ...
    if len(all_inputs) != test_cases:
        print("Failed to create tests data for tests.")
    return all_inputs
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="output tests data path. Default is current directory.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="number of tests cases to be generated",
    )
...
def create_and_save_test_data(
    ...
    """Create tests data for a model, and save tests data to a directory.
...
def main():
    ...
    if output_dir is not None:
        ...
        print("Directory existed. tests data files will be overwritten.")
