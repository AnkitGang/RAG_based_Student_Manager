...
def run_test(
    ...
    # Use random mask length for accuracy tests. It might introduce slight inflation in latency reported in this script.
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="output tests data path. If not specified, tests data will not be saved.",
    )
