...
# Example command to run tests on batch_size 1 and 2 for a model on GPU:
...
def run_one_test(model_setting, test_setting, perf_results, all_inputs, intra_op_num_threads):
    ...
    if key in perf_results:
        print("skip duplicated tests:", key)
        return

    print("Running tests:", key)
...
def run_performance(model_setting, test_setting, perf_results):
    ...
    # Do not generate random mask for performance tests.
    print(
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="random seed. Use the same seed to make sure tests data is same in multiple tests.",
    )
...
def main():
    ...
    for batch_size in batch_size_set:
        ...
        print("tests setting", test_setting)
