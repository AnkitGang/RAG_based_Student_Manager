...
def parse_arguments(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    test_group.add_argument(
        ...
        required=False,
        action="store_true",
        help="tests PyTorch performance",
    )
    ...
    test_group.add_argument(
        ...
        required=False,
        action="store_true",
        help="save tests data for onnxruntime_perf_test tool",
    )
...
def test_gpt_model(
    ...
    # Use different length sentences to tests batching
...
def test_t5_model(args: argparse.Namespace, sentences: list[str] | None = None):
    ...
    if args.prefix_vocab_mask:
        logger.debug("Skipping parity tests as prefix vocab mask is not implemented by Hugging Face")
        return None
...
def main(argv: list[str] | None = None, sentences: list[str] | None = None):
    ...
    if args.model_type == "gpt2" and is_greedy:
        if args.top_p > 0.0 and args.top_p < 1.0:
            ...
            logger.info(
                "The tests for gpt2_sampling onnx model is limited to non-custom model with small top_p(e.g <=0.01) value. The result should be the same as gpt2 greedy search."
            )
