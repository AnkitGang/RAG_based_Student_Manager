...
class HumanFriendlyTestCase(TestCase):
    ...
    """Container for the `humanfriendly` tests suite."""
    ...
    def test_format_number(self):
        ...
        # Regression tests for https://github.com/xolox/python-humanfriendly/issues/40.
    ...
    def test_spinner(self):
        ...
        stream = StringIO()
        spinner = Spinner(label='tests spinner', total=4, stream=stream, interactive=True)
        ...
        self.assertTrue(all('tests spinner' in line for line in lines))
    ...
    def test_automatic_spinner(self):
        ...
        There's not a lot to tests about the :class:`.AutomaticSpinner` class,
        ...
        """
        with AutomaticSpinner(label='tests spinner'):
            time.sleep(1)
    ...
    def test_cli(self):
        ...
        # Test `humanfriendly --demo'. The purpose of this tests is
        ...
        # written as a regression tests after issue #28 was reported:
    ...
    def test_find_terminal_size(self):
        ...
        # on what environments this tests suite will run in the future.
        assert lines > 0
        assert columns > 0
        ...
        # tests the fall back code paths though. However there's an easy way to
    ...
    def test_terminal_capabilities(self):
        ...
        for test_stream in connected_to_terminal, terminal_supports_colors:
            # This tests suite should be able to run interactively as well as
    ...
    def test_show_pager(self):
        ...
        try:
            ...
            # run the tests suite in an interactive terminal :-).
...
def normalize_timestamp(value, ndigits=1):
    ...
    This helps to make the tests suite less sensitive to timing issues caused by
