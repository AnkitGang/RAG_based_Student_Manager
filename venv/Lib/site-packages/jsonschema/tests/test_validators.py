...
class ValidatorTestMixin(MetaSchemaTestsMixin):
    ...
    def test_evolve_with_subclass(self):
        ...
        ensure they can move to supported APIs, but this tests ensures that in
...
class TestLatestValidator(TestCase):
    """
    These really apply to multiple versions but are easiest to tests on one.
    """
