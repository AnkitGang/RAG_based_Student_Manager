...
def infer_storage_options(
    ...
    Examples
    --------
    >>> infer_storage_options('/mnt/datasets/tests.csv')  # doctest: +SKIP
    {"protocol": "file", "path", "/mnt/datasets/tests.csv"}
    >>> infer_storage_options(
    ...     'hdfs://username:pwd@node:123/mnt/datasets/tests.csv?q=1',
    ...     inherit_storage_options={'extra': 'value'},
    ... )  # doctest: +SKIP
    {"protocol": "hdfs", "username": "username", "password": "pwd",
    "host": "node", "port": 123, "path": "/mnt/datasets/tests.csv",
