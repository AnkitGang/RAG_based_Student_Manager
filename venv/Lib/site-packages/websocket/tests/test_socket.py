...
class SocketTest(unittest.TestCase):
    ...
    def test_recv_normal(self):
        ...
        mock_sock = Mock()
        mock_sock.recv.return_value = b"tests data"

        result = recv(mock_sock, 9)

        self.assertEqual(result, b"tests data")
    ...
    def test_send_normal(self):
        ...
        result = send(mock_sock, b"tests data")

        self.assertEqual(result, 9)
        mock_sock.send.assert_called_with(b"tests data")
    ...
    def test_send_zero_timeout(self):
        ...
        self.assertEqual(result, 9)
        mock_sock.send.assert_called_once_with(b"tests data")
    ...
    def test_send_string_data(self):
        ...
        result = send(mock_sock, "tests data")
