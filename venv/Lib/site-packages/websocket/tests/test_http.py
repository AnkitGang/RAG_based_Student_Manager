...
# Skip tests to access the internet unless TEST_WITH_INTERNET == 1
...
class HttpTest(unittest.TestCase):
    ...
    def test_connect(self):
        ...
        # The following tests fails on Mac OS with a gaierror, not an OverflowError
    ...
    @unittest.skipUnless(TEST_WITH_INTERNET, "Internet-requiring tests are disabled")
    @unittest.skipUnless(
        TEST_WITH_PROXY, "This tests requires a HTTP proxy to be running on port 8899"
    )
    @unittest.skipUnless(
