...
class LargePayloadTest(unittest.TestCase):
    ...
    def test_ssl_large_payload_simulation(self):
        ...
        # This tests demonstrates that the 16KB limit in frame buffer protects against SSL issues
        payload_size = 16385
    ...
    def test_max_frame_size_limits(self):
        ...
        # (This is a very large tests, so we'll use a smaller representative size)
