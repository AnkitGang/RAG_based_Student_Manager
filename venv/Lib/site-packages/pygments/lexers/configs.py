...
class SquidConfLexer(RegexLexer):
    ...
    # There is no tests where it is used.
...
class AugeasLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(del|store|value|counter|seq|key|label|autoload|incl|excl|transform|tests|get|put)(\s+)', bygroups(Name.Builtin, Whitespace)),
...
class SingularityLexer(RegexLexer):
    ...
    _section = r'^(%(?:pre|post|setup|environment|help|labels|tests|runscript|files|startscript))(\s*)'
    _appsect = r'^(%app(?:install|help|run|labels|env|tests|files))(\s*)'
