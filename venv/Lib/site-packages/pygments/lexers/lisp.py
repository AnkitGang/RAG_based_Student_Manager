...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'make-will-executor', 'map', 'match-equality-tests',
        ...
        'prop:opt-chaperone-contract', 'prop:opt-chaperone-contract-get-tests',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'define-fringe-bitmap', 'define-hash-table-tests', 'define-key',
        ...
        'hash-table-rehash-threshold', 'hash-table-size', 'hash-table-tests',
        ...
        'terminal-parameters', 'terpri', 'tests-completion',
