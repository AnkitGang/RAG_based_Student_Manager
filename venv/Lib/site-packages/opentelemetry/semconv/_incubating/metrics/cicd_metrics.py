...
"""
The number of errors encountered in pipeline runs (eg. compile, tests failures)
Instrument: counter
Unit: {error}
...
def create_cicd_pipeline_run_errors(meter: Meter) -> Counter:
    ...
    return meter.create_counter(
        ...
        description="The number of errors encountered in pipeline runs (eg. compile, tests failures).",
        unit="{error}",
    )
...
Instrument: counter
Unit: {error}
Note: Errors in pipeline run execution are explicitly excluded. Ie a tests failure is not counted in this metric.
"""
