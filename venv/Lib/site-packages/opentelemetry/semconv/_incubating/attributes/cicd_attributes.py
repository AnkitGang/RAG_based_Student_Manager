...
class CicdPipelineResultValues(Enum):
    ...
    FAILURE = "failure"
    """The pipeline run did not finish successfully, eg. due to a compile error or a failing tests. Such failures are usually detected by non-zero exit codes of the tools executed in the pipeline run."""
    ERROR = "error"
...
class CicdPipelineRunStateValues(Enum):
    ...
    EXECUTING = "executing"
    """The executing state spans the execution of any run tasks (eg. build, tests)."""
...
class CicdPipelineTaskRunResultValues(Enum):
    ...
    FAILURE = "failure"
    """The task run did not finish successfully, eg. due to a compile error or a failing tests. Such failures are usually detected by non-zero exit codes of the tools executed in the task run."""
    ERROR = "error"
