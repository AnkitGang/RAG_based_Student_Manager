...
def test_get_builtins_holds() -> None:
    ...
    This tests is intended to be temporary until the ef migration is complete as
...
class CustomEmbeddingFunction(EmbeddingFunction[Embeddable]):
    ...
    def __call__(self, input: Embeddable) -> Embeddings:
        raise Exception("This is a tests exception")
...
def test_validation_context_with_custom_ef() -> None:
    ...
    with pytest.raises(Exception) as excinfo:
        custom_ef(["tests data"])

    original_msg = "This is a tests exception"
