...
# This machine shares a lot of similarity with the machine in chromadb/tests/property/test_persist.py.
...
def test_restart_persisted_client(sqlite_persistent: System) -> None:
    # TODO: This tests is broken for rust bindings and should be fixed
