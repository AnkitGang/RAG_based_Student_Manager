...
# ones called early in a tests) can have an outside effect. Generating lists with
...
class ExternalCollection:
    ...
    be used to tests the API and client code.
    """
...
class Collection(ExternalCollection):
    ...
    collection. It is a superset of ExternalCollection and should be used to tests
