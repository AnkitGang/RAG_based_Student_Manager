"""
Integration tests for the Collection statistics wrapper methods
"""
...
def test_statistics_wrapper(basic_http_client: System) -> None:
    ...
    collection.add(
        ids=["doc1", "doc2", "doc3"],
        documents=["tests document 1", "tests document 2", "tests document 3"],
        metadatas=[
...
# commenting out for now as waiting for query cache invalidateion slows down the tests suite
