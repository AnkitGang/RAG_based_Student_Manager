...
TEST_ANOTHER_DATA = "another-tests-data"
TEST_ANOTHER_DATA_BASE64 = _base64(TEST_ANOTHER_DATA)

TEST_HOST = "tests-host"
TEST_USERNAME = "me"
TEST_PASSWORD = "pass"
# token for me:pass
...
TEST_OIDC_TOKEN = "tests-oidc-token"
TEST_OIDC_INFO = "{\"name\": \"tests\"}"
TEST_OIDC_BASE = ".".join([
...
TEST_OIDC_EXP = "{\"name\": \"tests\",\"exp\": 536457600}"
...
TEST_AZURE_TOKEN = "tests-azure-token"
...
class TestConfigNode(BaseTestCase):
    ...
    test_obj = {"key1": "tests", "key2": ["a", "b", "c"],
    ...
    def test_normal_map_array_operations(self):
        self.assertEqual("tests", self.node['key1'])
