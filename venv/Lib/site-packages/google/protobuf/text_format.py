...
# TODO Import thread contention leads to tests failures.
...
def Parse(text,
  ...
  Example::
    ...
    a = MyProto()
    a.repeated_field.append('tests')
    b = MyProto()

    # Repeated fields are combined
    text_format.Parse(repr(a), b)
    text_format.Parse(repr(a), b) # repeated_field contains ["tests", "tests"]
    ...
    # Binary version:
    b.ParseFromString(a.SerializeToString()) # repeated_field is now "tests"
